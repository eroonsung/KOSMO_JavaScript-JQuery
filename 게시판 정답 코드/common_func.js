...
//***********************************************************************
//***********************************************************************
// 매개변수로 들어온 날짜문자와  오늘날짜와의 차이를 일수로 리턴하는 함수 선언
//***********************************************************************
...
function get_dDay(dateStr) {
	try{
		...
		// 오늘 날짜를 관리하는 Date 객체 생성하고 변수 today 에 저장하기
		//------------------------------
		var xDay = new Date(year,month-1,date);
		var today = new Date();

		//------------------------------
		// 오늘 날짜와 임의의 날짜의 차이를 일수로 얻고 소수점 첫째 자리를 무조건 올린 후 변수 interval 에 저장하기
		//------------------------------
		var interval = (  xDay.getTime()-today.getTime()  )/( 1000*60*60*24 );
		//------------------------------
		// interval 변수 안의 데이더 리턴하기
		//------------------------------
		return Math.ceil(interval);
	}
	catch(e){
		alert("get_dDay 함수 에서 에러발생!" + e.message )
		return -1;
	}
